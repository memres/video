...
<html lang="en">
	<head>
		...
		<title><?php
			if ($id) echo htmlspecialchars($video_title, ENT_QUOTES).' &ndash; ';
			else {
				if ($channel and $channel_title) echo "$channel_title &ndash; ";
				if ($term) echo htmlspecialchars($term, ENT_QUOTES).' &ndash; ';
			}
			echo $site_title;
		?></title>
		<meta name="description" content="<?php
			if ($id && $video_description) echo htmlspecialchars($video_description, ENT_QUOTES);
			else echo $site_description;
		?>"/>
		<meta property="og:title" content="<?php
			if ($id) echo htmlspecialchars($video_title, ENT_QUOTES);
			elseif ($channel and $channel_title) echo $channel_title;
		...
		<meta name="twitter:site" content="@vidyotube"/>
		<meta name="twitter:creator" content="@mes"/>
		<meta name="author" content="video@emresanli.com"/>
		<meta name="theme-color" content="#f1f1f1"/>
		<link rel="shortcut icon" href="favicon.ico"/>
		<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/memres/video@384b0f1c5217e97d71a6636ab04588377d83e638/style.css"/>
	...
	<body>
		<div class="container">
			...
			<div class="ten columns half-bottom menu">
				<ul>
					...
					<li><a class="toggle-categories"><i class="fa fa-folder-open"></i> Categories</a></li>
					<li><a class="toggle-search"><i class="fa fa-search"></i> Search</a></li>
				</ul>
			</div>
			<div class="sixteen columns search">
				<form action="./">
					...
					<div class="four columns checkbox omega half-bottom">
						<label><input type="checkbox" name="caption" value="1"<?php if ($caption) echo ' checked="checked"'; ?>><span class="cc">Caption</span></label>
					</div>
...
<?php if ($channel || $search) { ?>
			<div class="sixteen columns half-bottom title">
				<h4><?php
					if ($channel and $channel_title) echo $channel_title;
					if ($search) {
						if ($channel and $channel_title) echo ' ';
...
<?php } if ($id) { ?>
			...
			<div class="sixteen columns half-bottom info">
				...
				<div class="four columns">
					<p>View Count:</p>
					<h5 class="ellipsis"><?= $video_views; ?></h5>
				</div>
				<div class="four columns omega">
					<p>Rating:</p>
					<h5 class="ellipsis"><?= $video_rating; ?></h5>
				</div>
			</div>
			<div class="sixteen columns half-bottom share">
				<div class="four columns alpha">
				...
				<div class="four columns">
					<a width="662" height="666" href="https://wa.me/?text=<?= urlencode($url); ?>">
						<span class="fa-stack fa-lg">
							<i class="fa fa-circle fa-stack-2x"></i>
			...
			<div class="sixteen columns half-bottom">
				<h4><?= $video_title; ?></h4>
				<h5>Published by <a href="?channel=<?= $video_channid ?>"><?= $video_channel ?></a></h5>
			</div>
<?php if ($video_description) { ?>
			<div class="sixteen columns half-bottom description">
...
?>
			<div class="four columns">
				<div class="row thumb">
					<a href="?id=<?= $video_id; ?>">
						<img class="scale" src="<?= $video_image; ?>" alt="<?= htmlspecialchars($video_title, ENT_QUOTES); ?>"/>
						<div class="caption">
...
<?php } } else { ?>
			<div class="sixteen columns add-bottom center">
				<i class="fa fa-times-circle fa-2x"></i>
				<h4 class="add-bottom">No videos found<?php if ($channel) echo ' in this channel'; if ($search) echo ' matching with your query'; ?>.</h4>
			</div>
<?php } } ?>
			<div class="sixteen columns">
				<div class="row footer">
					...
					<div class="one-third column omega right">
						<h6><a href="https://www.emresanli.com/"><i class="fa fa-desktop"></i> <i class="fa fa-tablet"></i> <i class="fa fa-mobile-phone"></i></a></h6>
					</div>
				</div>
			</div>
			<div class="sixteen columns">
				<div class="row about">
					<div class="eight columns alpha">
						<p><b><?= $site_title; ?></b> has been firstly created in 2006 as a course project. Initial version was just a single page embedding live television channels. In time this thing has turned into an online theater by containing hundreds of movies and episodes of popular drama series. Via the latest version of the project which is completely renovated in 2017, billions of <b>YouTube</b> videos can be reached hassle free, even if it is blocked at your location.</p>
					</div>
					<div class="eight columns omega">
						<p>You can list videos using user-friendly search engine, and also under various categories pregenerated for easy access. Watch unlimited ad-free videos with <b>AutoPlay</b> and <b>Continuous Playing</b> options. Last but not least, there is an extra feature YouTube still does not have that you may jump to a <b>random</b> video by a single click whenever you feel lucky. If you want to stay in touch, you are welcome to follow <a href="https://twitter.com/vidyotube"><?= $site_title; ?> on <i class="fa fa-twitter-square"></i></a></p>
					</div>
				</div>
			</div>
		</div>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
		<script src="https://cdn.jsdelivr.net/gh/memres/video@9e7f18fbc8253d7b5a67ee9c7aeb80e5b492607e/main.js"></script>
<?php if ($id) { ?>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/js-cookie/2.2.0/js.cookie.min.js"></script>
		<script src="https://cdn.jsdelivr.net/gh/memres/video@4b8e3bbf8a6a3641dab6e05e31e466870aa3e77b/video.js"></script>
